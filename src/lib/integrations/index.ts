...
export * as emailParser from './email-parser'
...
// TODO: Database operations for integrations
// Tables 'integrations' and 'integration_sync_logs' need to be created first
